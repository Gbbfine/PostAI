  ...
  return (
    <section className='relative z-10 overflow-hidden px-6 py-24 md:py-32'>
      ...
      <div
        ...
        style={{
          background: [
            'radial-gradient(ellipse 50% 50% at 30% 50%, oklch(0.7 0.17 28 / 70%) 0%, transparent 70%)',
            'radial-gradient(ellipse 40% 40% at 72% 38%, oklch(0.68 0.12 205 / 48%) 0%, transparent 70%)',
          ].join(', '),
        }}
      />
