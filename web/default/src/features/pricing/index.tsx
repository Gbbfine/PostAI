    ...
    <PublicLayout showMainContainer={false}>
      <div className='relative'>
        <div
          ...
          style={{
            background: [
              'radial-gradient(ellipse 60% 50% at 20% 20%, oklch(0.72 0.18 28 / 80%) 0%, transparent 70%)',
              'radial-gradient(ellipse 50% 40% at 80% 15%, oklch(0.67 0.13 205 / 58%) 0%, transparent 70%)',
              'radial-gradient(ellipse 40% 35% at 50% 70%, oklch(0.78 0.15 82 / 34%) 0%, transparent 70%)',
            ].join(', '),
