                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          {t(
                            'Custom API base URL. For official channels, the platform already provides built-in addresses. Only fill this for third-party proxy sites or special endpoints. Do not add /v1 or a trailing slash.'
                          )}
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
